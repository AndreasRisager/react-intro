...
export default function ShoppingCart() {
	...
	return (
		<div className="shoppingCartContainer">
			<button onClick={toggleShowCart}><i className="fas fa-shopping-cart"></i></button>
						...
						return shoppingCart.map(product => (
							<li className="shoppingCart__item">
								<article>
									...
									<button aria-label="Remove from cart" onClick={() => removeFromCart(product.sku)}><i className="fas fa-times"></i></button>
								</article>
							</li>
						))
					}}
